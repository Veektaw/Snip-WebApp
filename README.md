...
1. Clone this repo
```sh
git clone https://github.com/Unique-Red/Snip-webapp.git
```
...
```sh
set FLASK_APP=app.py or FLASK_APP=app
FLASK_DEBUG=True
```
On gitbash terminal
```sh
export FLASK_APP=run.py or flask run
```
7. Create database
```sh
flask shell
